...
//extern INTERRUPT void TIM4_UPD_OVF_IRQHandler(void);
...
struct interrupt_vector const _vectab[] = {
	...
	{0x82, (interrupt_handler_t)UART3_TX_IRQHandler}, /* irq20 */
	{0x82, (interrupt_handler_t)UART3_RX_IRQHandler}, /* irq21 */
